...
```{r}
autoplot(grid_results, id = 'corr_log_reg')
```

### K-Nearest Neighbors
```{r}
autoplot(grid_results, id = 'corr_knn')
```

### Random Forest
```{r}
autoplot(grid_results, id = 'simple_random_forest')

rf_wf <- grid_results %>% 
  extract_workflow_set_result(id ='simple_random_forest')
