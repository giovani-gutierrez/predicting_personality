...
```{r}
pca_rec <- recipe(e_i ~ ., data = person_train) %>% 
...
```{r}
elastic_spec <- logistic_reg(mixture = tune(),
                            penalty = tune()) %>% 
...
tuned_elastic %>% 
  write_rds(file = 'C:/Users/giova/Desktop/PSTAT 131/predicting_personality/predicting_personality_files/Models/tuned_elastic.rds')
```
...
tuned_knn %>% 
  write_rds(file = 'C:/Users/giova/Desktop/PSTAT 131/predicting_personality/predicting_personality_files/Models/tuned_knn.rds')
```
